...
$objPHPExcel->setActiveSheetIndex(0)
            ->setCellValue('A1', '#')
            ->setCellValue('B1', 'Təyinat')
            ->setCellValue('C1', 'Məbləğ')
            ->setCellValue('D1', 'Tarix');
...
while ($info=mysqli_fetch_array($baza)) {
    ...
    $objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('B'.$sira, $info['teyinat'])
            ->setCellValue('C'.$sira, $info['mebleg'])
            ->setCellValue('D'.$sira, $info['tarix']);
}
