                ...
                <div class="col-lg-6">
                    <div class="login__form">
                        ...
                        <form action="#">
                            ...
                            <div class="input__item">
                                <input type="text" placeholder="Şifrəniz">
                                <span class="icon_lock"></span>
                            </div>
                            <button type="submit" name="daxilol" class="site-btn">Giriş Edin</button>&nbsp;
                        </form>
                        <a href="#" class="forget_pass">Şifrəni Unutmusunuz?</a>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="login__register">
                        <h3>Hesabınız Yoxdur?</h3>
                        <button type="submit" name ="qeydiyyat" class="primary-btn">Qeydiyyatdan Keçin</button>
                    </div>
                </div>
            </div>
